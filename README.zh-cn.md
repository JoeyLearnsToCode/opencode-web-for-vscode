...
一款可以在侧边栏使用 OpenCode web 功能的 VSCode 扩展。
...
<img src="https://raw.githubusercontent.com/JoeyLearnsToCode/opencode-web-for-vscode/master/screenshot/menu_view.png" width="600"/>
...
| `opencode.language` | string | `auto` | 界面语言（`auto`/`zh-cn`/`en`/`ja`/`ko`） |
...
你可以通过以下方式切换语言：
1. 在设置中修改 `opencode.language` 配置
2. 点击 Webview 右上角的语言切换按钮（OpenCode 运行时）
3. 通过侧边栏工具栏的"更多操作"菜单 → "切换语言"
...
如有问题和功能建议，请访问 [GitHub 仓库](https://github.com/JoeyLearnsToCode/opencode-web-for-vscode)。
